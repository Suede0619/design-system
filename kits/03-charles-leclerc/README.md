# Charles Leclerc — Atomic Kit

> Editorial luxury meets motorsport — serif gravitas, deep blacks, and Ferrari red as deliberate punctuation.

**CSSDA #3 of 2025 (8.85)** · Editorial Luxury / Motorsport · [reference site](https://charlesleclerc.com)
...
```
Apply the design system in ./03-charles-leclerc/ to this project. Follow AGENTS.md.
```
