# Mother Design — Atomic Kit

> Light Canela serif on warm cream — an art book that happens to be a website.

**D&AD Pencil, Awwwards SOTD** · Studio / Confident Minimal · [reference site](https://motherdesign.com)
...
```
Apply the design system in ./30-motherdesign/ to this project. Follow AGENTS.md.
```
