...
**Dev community favorite** · Developer / Dark Emerald · [reference site](https://supabase.com)
...
```
Apply the design system in ./23-supabase/ to this project. Follow AGENTS.md.
```
