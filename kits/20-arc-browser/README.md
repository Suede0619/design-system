# Arc Browser — Atomic Kit

> A browser that loves you back — soft gradient pills, floating screenshots, and warm Mac-native whimsy.

**Multiple design awards** · Browser / Gradient Whimsy · [reference site](https://arc.net)
...
```
Apply the design system in ./20-arc-browser/ to this project. Follow AGENTS.md.
```
