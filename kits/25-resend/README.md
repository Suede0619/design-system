...
**Awwwards Site of the Day** · Developer Email / Minimal Dark · [reference site](https://resend.com)
...
```
Apply the design system in ./25-resend/ to this project. Follow AGENTS.md.
```
