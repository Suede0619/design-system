# Headspace — Atomic Kit

> Every interaction feels like a gentle exhale — softness as a feature, not a weakness.

**Webby + Apple Design Award** · Wellness / Warm Illustration · [reference site](https://headspace.com)
...
```
Apply the design system in ./38-headspace/ to this project. Follow AGENTS.md.
```
