# Dropbox Brand — Atomic Kit

> Ultra-clean Swiss minimalism — a design system about a design system, precise enough to cut glass.

**CSSDA Website of the Year 2025** · Swiss Minimal / Brand Guidelines · [reference site](https://brand.dropbox.com)
...
```
Apply the design system in ./02-dropbox-brand/ to this project. Follow AGENTS.md.
```
