# Bürocratik — Atomic Kit

> Editorial maximalism in monochrome — oversized type, absolute black-and-white contrast, red as an exclamation mark.

**CSSDA Best Agency + EDAwards #1 Europe** · Editorial Maximalism / Monochrome Brutalist · [reference site](https://www.burocratik.com)
...
```
Apply the design system in ./06-burocratik/ to this project. Follow AGENTS.md.
```
