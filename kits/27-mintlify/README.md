...
**Dev community standard** · Documentation / Fresh Green · [reference site](https://mintlify.com)
...
```
Apply the design system in ./27-mintlify/ to this project. Follow AGENTS.md.
```
