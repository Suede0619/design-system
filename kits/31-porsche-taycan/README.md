# Porsche Taycan — Atomic Kit

> Razor-sharp zero-radius precision — cinema staged for a single product.

**iF Design Award, Webby** · Automotive / Performance Luxury · [reference site](https://www.porsche.com/taycan)
...
```
Apply the design system in ./31-porsche-taycan/ to this project. Follow AGENTS.md.
```
