# The Monolith Project — Atomic Kit

> Confrontational machine-aesthetic anti-design: pure black/white, all-monospace, and a cursor that is the artwork.

**CSSDA #4 of 2025 (8.85)** · Experimental / Anti-Design · [reference site](https://monolith.world)
...
```
Apply the design system in ./15-monolith/ to this project. Follow AGENTS.md.
```
