...
**Multiple Webby Awards** · Developer Fintech / Gradient Dark · [reference site](https://stripe.com)
...
```
Apply the design system in ./07-stripe/ to this project. Follow AGENTS.md.
```
