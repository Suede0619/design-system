# Teenage Engineering — Atomic Kit

> The internet as a product manual from the future — utility is beauty, the website stays invisible.

**D&AD Yellow Pencil + iF Design** · Product / Industrial Brutalism · [reference site](https://teenage.engineering)
...
```
Apply the design system in ./40-teenage-engineering/ to this project. Follow AGENTS.md.
```
