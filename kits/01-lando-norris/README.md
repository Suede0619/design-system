# Lando Norris — Atomic Kit

> High-contrast dark cinema where every scroll accelerates through a tunnel of papaya orange and white.

**Awwwards Site of the Year 2025** · Cinematic Sports / Dark Mode · [reference site](https://landonorris.com)
...
```
Apply the design system in ./01-lando-norris/ to this project. Follow AGENTS.md.
```
